  ...
  var rightKey = rightKeys[Math.floor(Math.random()*rightKeys.length)];
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails,snippet&id='+video+'&key='+rightKey, function(data) {
        ...
        if (rightKeys.length == 0) {
            $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=statistics,liveStreamingDetails&id='+video, function(data) {
...
window.onload = () => {
    ...
    $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=snippet&id='+video, function(data) {
