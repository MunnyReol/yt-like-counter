   ...
   function diff() {
       $.getJSON('https://www.googleapis.com/youtube/v3/videos?part=statistics&id=' + video1 + '&key=' + key, function(data) {
         $.getJSON('https://www.googleapis.com/youtube/v3/videos?part=statistics&id=' + video2 + '&key=' + key, function(data2) {
           $('#count3').html(Math.abs(data.items[0].statistics.dislikeCount - data2.items[0].statistics.dislikeCount));
         })
       });
   }
   ...
   function search1() {
       ...
       $.getJSON('https://www.googleapis.com/youtube/v3/search?part=id&maxResults=1&type=video&q=' + replaceurl + '&key=' + key, function(data) {
         window.location.href = '/yt-like-counter/compare/dislikes/?q1=' + data.items[0].id.videoId + '&q2=' + video2;
       })
   }
   ...
   function search2() {
       ...
       $.getJSON('https://www.googleapis.com/youtube/v3/search?part=id&maxResults=1&type=video&q=' + replaceurl + '&key=' + key, function(data) {
         window.location.href = '/yt-like-counter/compare/dislikes/?q1=' + video1 + '&q2=' + data.items[0].id.videoId;
       })
   }
