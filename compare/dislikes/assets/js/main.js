...
window.onload = () => {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/videos?part=statistics,snippet&id='+video1+','+video2+'&key='+rightKey, function(data) {
        ...
        $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=statistics&id='+video1, function(data) {
            $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=statistics&id='+video2, function(data2) {
        ...
        if (rightKeys.length == 0) {
            $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=snippet&id='+video1, function(data) {
                $.getJSON('https://yt.livecounts.io/yt_data?type=video&part=snippet&id='+video2, function(data2) {
...
function search1() {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=video&q=' + replaceurl + '&key=' + rightKey, function(data) {
        ...
        $.getJSON('https://yt.livecounts.io/yt_data?type=search&part=video&q='+replaceurl, function(data) {
